...
public:
  ...
  double camera_marker_scale_;
  double frame_marker_scale_;
  std::vector<std::pair<Vector3d, int>> new_points_;
  std::vector<std::pair<Vector3d, int>> old_points_;
  Visualizer();

  ~Visualizer() {};

  void scalarToColormap(double val, cv::Scalar& col);
